    ...
    <div class="container mt-5">
        ...
        <b-form @submit.prevent="handleSubmit" class="w-50 mx-auto">
            ...
            <b-form-group label="電話" label-for="phone">
                <b-form-input id="phone" v-model="member.phone" type="tel" placeholder="請輸入電話" :state="isPhoneValid"
                    required />
...
onMounted(async () => {
    ...
    try {
        const res = await axios.get(`http://localhost:8080/members/get/${id}`)
